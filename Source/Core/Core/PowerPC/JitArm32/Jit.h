...
private:
  ...
  JitArmAsmRoutineManager asm_routines{*this};
...
public:
  ...
  void CompileInstruction(PPCAnalyst::CodeOp& op);
	...
	static void WriteToFifo(u32 data);
	void WriteCallInterpreter(UGeckoInstruction _inst);
	void Cleanup();

	void ComputeRC(ArmGen::ARMReg value);
	void ComputeRC(s32 value);
	void ComputeRC3(ArmGen::ARMReg value);
	void ComputeRC3(s32 value);
