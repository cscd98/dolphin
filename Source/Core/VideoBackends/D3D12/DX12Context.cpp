...
{
  constexpr u32 required =
    static_cast<u32>(D3D12_FORMAT_SUPPORT1_TEXTURE2D) |
    static_cast<u32>(D3D12_FORMAT_SUPPORT1_TEXTURECUBE) |
    static_cast<u32>(D3D12_FORMAT_SUPPORT1_SHADER_SAMPLE);
