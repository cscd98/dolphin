...
namespace winrt {
  ...
  namespace Windows {
    // Define System::Power first
    namespace System { namespace Power {
      // Projection with names Dolphin uses
      enum BatteryStatus { NotPresent, Discharging, Idle, Charging };
    } }

    namespace Devices {
      namespace Haptics {
        struct SimpleHapticsControllerFeedback { uint16_t Waveform() const { return 0; } };
      ...
      namespace Power {
        struct BatteryReport {
          ...
          struct Capacity { int GetInt32() const { return 0; } };
    ...
    namespace Gaming { namespace Input {
      struct GamepadReading {
        double LeftTrigger{}, RightTrigger{}, LeftThumbstickX{}, LeftThumbstickY{},
               RightThumbstickX{}, RightThumbstickY{};
      };
      struct GamepadVibration {
        double LeftMotor{}, RightMotor{}, LeftTrigger{}, RightTrigger{};
      };
      enum GameControllerSwitchPosition { Center, Up, Down, Left, Right };
      enum GameControllerSwitchKind { TwoWay, FourWay };
      enum GameControllerButtonLabel { None };
      ...
      struct RawGameController {
        ...
        SimpleHapticsControllers() const { return {}; }
